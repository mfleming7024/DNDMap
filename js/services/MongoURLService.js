...
angular.module('myApp')
	.service('MongoURLService', function ($http, $q) {
		...
		this.getMaps = function (mapName) {
			...
			$http.get('http://www.mikelweb.com/mongo/getMaps/')
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.getPaths = function (mapName) {
			...
			$http.get('http://www.mikelweb.com/mongo/getPaths/' + mapName)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.getMarkers = function (mapName) {
			...
			$http.get('http://www.mikelweb.com/mongo/getPoints/' + mapName)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.addPoint = function (mapName, pointName, lat, lng) {
			...
			$http.post('http://www.mikelweb.com/mongo/addPoint/' + mapName + '/' + pointName + '/' + lat + '/' + lng)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.deletePoint = function (mapName, pointName) {
			...
			$http.post('http://www.mikelweb.com/mongo/deletePoint/' + mapName + '/' + pointName)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.updatePoint = function (mapName, pointName, lat, lng) {
			...
			$http.post('http://www.mikelweb.com/mongo/updatePoint/' + mapName + '/' + pointName + '/' + lat + '/' + lng)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.updatePathPoint = function (mapName, pathName, coordIndex, newLat, newLng) {
			...
			$http.post('http://www.mikelweb.com/mongo/updatePathPoint/' + mapName + '/' + pathName + '/' + coordIndex + '/' + newLat + '/' + newLng)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
		...
		this.askBard = function (bardPrompt) {
			...
			$http.post('http://www.mikelweb.com/mongo/askBard/' + bardPrompt)
				.then(function (data) {
					def.resolve(data);
				}, function (error) {
